...
def send_email(recipient: str, subject: str, html_body: str, text_body: str = "") -> None:
    ...
    msg["Precedence"] = "bulk"
    msg["X-Mailer"] = "Garment-Mailer/1.0"
...
<div style="display:none;font-size:1px;line-height:1px;max-height:0;max-width:0;overflow:hidden;opacity:0">Use code {otp} to complete your request on Garment.</div>
...
<p style="margin:0;font-size:12px;color:#aaaabb">Garment E-commerce Platform</p>
</td></tr>
</table>
</td></tr>
</table>
...
def send_password_reset_email(recipient: str, otp: str) -> None:
    subject = "Password Reset OTP – Garment"
